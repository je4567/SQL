...
select*from financial_transactions where payment_status="overdue";
...
select*from financial_transactions where invoice_amount between 12000 and 15000;
select*from financial_transactions where invoice_amount between 12000 and 20000;
select*from financial_transactions where invoice_amount between 9000 and 11000;
select*from financial_transactions where invoice_amount between 15000 and 20000;
...
select*from financial_transactions where  customer_name like "D%";
select payment_status from financial_transactions;
